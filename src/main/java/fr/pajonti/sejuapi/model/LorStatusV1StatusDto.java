...
public class LorStatusV1StatusDto {
  ...
  private List<LorStatusV1ContentDto> titles = new ArrayList<>();

  public static final String SERIALIZED_NAME_UPDATES = "updates";
  @SerializedName(SERIALIZED_NAME_UPDATES)
  private List<LorStatusV1UpdateDto> updates = new ArrayList<>();
  ...
  public LorStatusV1StatusDto() {
  }

  public LorStatusV1StatusDto id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public LorStatusV1StatusDto maintenanceStatus(MaintenanceStatusEnum maintenanceStatus) {
  ...
  **/
  ...
  public LorStatusV1StatusDto incidentSeverity(IncidentSeverityEnum incidentSeverity) {
  ...
  **/
  ...
  public LorStatusV1StatusDto titles(List<LorStatusV1ContentDto> titles) {
    this.titles = titles;
    return this;
  }

  public LorStatusV1StatusDto addTitlesItem(LorStatusV1ContentDto titlesItem) {
    if (this.titles == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<LorStatusV1ContentDto> getTitles() {
    return titles;
  }

  public void setTitles(List<LorStatusV1ContentDto> titles) {
    this.titles = titles;
  }


  public LorStatusV1StatusDto updates(List<LorStatusV1UpdateDto> updates) {
    this.updates = updates;
    return this;
  }

  public LorStatusV1StatusDto addUpdatesItem(LorStatusV1UpdateDto updatesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<LorStatusV1UpdateDto> getUpdates() {
    return updates;
  }

  public void setUpdates(List<LorStatusV1UpdateDto> updates) {
    this.updates = updates;
  }


  public LorStatusV1StatusDto createdAt(String createdAt) {
  ...
  **/
  ...
  public LorStatusV1StatusDto archiveAt(String archiveAt) {
  ...
  **/
  ...
  public LorStatusV1StatusDto updatedAt(String updatedAt) {
  ...
  **/
  ...
  public LorStatusV1StatusDto platforms(List<PlatformsEnum> platforms) {
    this.platforms = platforms;
    return this;
  }

  public LorStatusV1StatusDto addPlatformsItem(PlatformsEnum platformsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LorStatusV1StatusDto lorStatusV1StatusDto = (LorStatusV1StatusDto) o;
    return Objects.equals(this.id, lorStatusV1StatusDto.id) &&
        Objects.equals(this.maintenanceStatus, lorStatusV1StatusDto.maintenanceStatus) &&
        Objects.equals(this.incidentSeverity, lorStatusV1StatusDto.incidentSeverity) &&
        Objects.equals(this.titles, lorStatusV1StatusDto.titles) &&
        Objects.equals(this.updates, lorStatusV1StatusDto.updates) &&
        Objects.equals(this.createdAt, lorStatusV1StatusDto.createdAt) &&
        Objects.equals(this.archiveAt, lorStatusV1StatusDto.archiveAt) &&
        Objects.equals(this.updatedAt, lorStatusV1StatusDto.updatedAt) &&
        Objects.equals(this.platforms, lorStatusV1StatusDto.platforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class LorStatusV1StatusDto {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to LorStatusV1StatusDto
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LorStatusV1StatusDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LorStatusV1StatusDto is not found in the empty JSON string", LorStatusV1StatusDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LorStatusV1StatusDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LorStatusV1StatusDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LorStatusV1StatusDto.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraytitles.size(); i++) {
        LorStatusV1ContentDto.validateJsonElement(jsonArraytitles.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayupdates.size(); i++) {
        LorStatusV1UpdateDto.validateJsonElement(jsonArrayupdates.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LorStatusV1StatusDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LorStatusV1StatusDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LorStatusV1StatusDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LorStatusV1StatusDto.class));

       return (TypeAdapter<T>) new TypeAdapter<LorStatusV1StatusDto>() {
           @Override
           public void write(JsonWriter out, LorStatusV1StatusDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LorStatusV1StatusDto read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LorStatusV1StatusDto given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LorStatusV1StatusDto
  * @throws IOException if the JSON string is invalid with respect to LorStatusV1StatusDto
  */
  public static LorStatusV1StatusDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LorStatusV1StatusDto.class);
  }

 /**
  * Convert an instance of LorStatusV1StatusDto to an JSON string
  *
  * @return JSON string
  */
