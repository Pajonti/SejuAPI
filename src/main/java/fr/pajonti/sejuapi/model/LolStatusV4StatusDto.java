...
import fr.pajonti.sejuapi.model.LolStatusV4ContentDto;
import fr.pajonti.sejuapi.model.LolStatusV4UpdateDto;
...
public class LolStatusV4StatusDto {
  ...
  private List<LolStatusV4ContentDto> titles = new ArrayList<>();

  public static final String SERIALIZED_NAME_UPDATES = "updates";
  @SerializedName(SERIALIZED_NAME_UPDATES)
  private List<LolStatusV4UpdateDto> updates = new ArrayList<>();
  ...
  public LolStatusV4StatusDto() {
  }

  public LolStatusV4StatusDto id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public LolStatusV4StatusDto maintenanceStatus(MaintenanceStatusEnum maintenanceStatus) {
  ...
  **/
  ...
  public LolStatusV4StatusDto incidentSeverity(IncidentSeverityEnum incidentSeverity) {
  ...
  **/
  ...
  public LolStatusV4StatusDto titles(List<LolStatusV4ContentDto> titles) {
    this.titles = titles;
    return this;
  }

  public LolStatusV4StatusDto addTitlesItem(LolStatusV4ContentDto titlesItem) {
    if (this.titles == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<LolStatusV4ContentDto> getTitles() {
    return titles;
  }

  public void setTitles(List<LolStatusV4ContentDto> titles) {
    this.titles = titles;
  }


  public LolStatusV4StatusDto updates(List<LolStatusV4UpdateDto> updates) {
    this.updates = updates;
    return this;
  }

  public LolStatusV4StatusDto addUpdatesItem(LolStatusV4UpdateDto updatesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<LolStatusV4UpdateDto> getUpdates() {
    return updates;
  }

  public void setUpdates(List<LolStatusV4UpdateDto> updates) {
    this.updates = updates;
  }


  public LolStatusV4StatusDto createdAt(String createdAt) {
  ...
  **/
  ...
  public LolStatusV4StatusDto archiveAt(String archiveAt) {
  ...
  **/
  ...
  public LolStatusV4StatusDto updatedAt(String updatedAt) {
  ...
  **/
  ...
  public LolStatusV4StatusDto platforms(List<PlatformsEnum> platforms) {
    this.platforms = platforms;
    return this;
  }

  public LolStatusV4StatusDto addPlatformsItem(PlatformsEnum platformsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LolStatusV4StatusDto lolStatusV4StatusDto = (LolStatusV4StatusDto) o;
    return Objects.equals(this.id, lolStatusV4StatusDto.id) &&
        Objects.equals(this.maintenanceStatus, lolStatusV4StatusDto.maintenanceStatus) &&
        Objects.equals(this.incidentSeverity, lolStatusV4StatusDto.incidentSeverity) &&
        Objects.equals(this.titles, lolStatusV4StatusDto.titles) &&
        Objects.equals(this.updates, lolStatusV4StatusDto.updates) &&
        Objects.equals(this.createdAt, lolStatusV4StatusDto.createdAt) &&
        Objects.equals(this.archiveAt, lolStatusV4StatusDto.archiveAt) &&
        Objects.equals(this.updatedAt, lolStatusV4StatusDto.updatedAt) &&
        Objects.equals(this.platforms, lolStatusV4StatusDto.platforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class LolStatusV4StatusDto {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to LolStatusV4StatusDto
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LolStatusV4StatusDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LolStatusV4StatusDto is not found in the empty JSON string", LolStatusV4StatusDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LolStatusV4StatusDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LolStatusV4StatusDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LolStatusV4StatusDto.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("maintenance_status") != null && !jsonObj.get("maintenance_status").isJsonNull()) && !jsonObj.get("maintenance_status").isJsonPrimitive()) {
      ...
      // validate the optional field `maintenance_status`
      if (jsonObj.get("maintenance_status") != null && !jsonObj.get("maintenance_status").isJsonNull()) {
        MaintenanceStatusEnum.validateJsonElement(jsonObj.get("maintenance_status"));
      }
      if ((jsonObj.get("incident_severity") != null && !jsonObj.get("incident_severity").isJsonNull()) && !jsonObj.get("incident_severity").isJsonPrimitive()) {
      ...
      // validate the optional field `incident_severity`
      if (jsonObj.get("incident_severity") != null && !jsonObj.get("incident_severity").isJsonNull()) {
      ...
      for (int i = 0; i < jsonArraytitles.size(); i++) {
        LolStatusV4ContentDto.validateJsonElement(jsonArraytitles.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayupdates.size(); i++) {
        LolStatusV4UpdateDto.validateJsonElement(jsonArrayupdates.get(i));
      };
      if (!jsonObj.get("created_at").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `created_at` to be a primitive type in the JSON string but got `%s`", jsonObj.get("created_at").toString()));
      }
      if ((jsonObj.get("archive_at") != null && !jsonObj.get("archive_at").isJsonNull()) && !jsonObj.get("archive_at").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LolStatusV4StatusDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LolStatusV4StatusDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LolStatusV4StatusDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LolStatusV4StatusDto.class));

       return (TypeAdapter<T>) new TypeAdapter<LolStatusV4StatusDto>() {
           @Override
           public void write(JsonWriter out, LolStatusV4StatusDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LolStatusV4StatusDto read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LolStatusV4StatusDto given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LolStatusV4StatusDto
  * @throws IOException if the JSON string is invalid with respect to LolStatusV4StatusDto
  */
  public static LolStatusV4StatusDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LolStatusV4StatusDto.class);
  }

 /**
  * Convert an instance of LolStatusV4StatusDto to an JSON string
  *
  * @return JSON string
  */
