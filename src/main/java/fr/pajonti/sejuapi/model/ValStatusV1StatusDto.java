...
import fr.pajonti.sejuapi.model.ValStatusV1ContentDto;
import fr.pajonti.sejuapi.model.ValStatusV1UpdateDto;
...
public class ValStatusV1StatusDto {
  ...
  private List<ValStatusV1ContentDto> titles = new ArrayList<>();

  public static final String SERIALIZED_NAME_UPDATES = "updates";
  @SerializedName(SERIALIZED_NAME_UPDATES)
  private List<ValStatusV1UpdateDto> updates = new ArrayList<>();
  ...
  public ValStatusV1StatusDto() {
  }

  public ValStatusV1StatusDto id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ValStatusV1StatusDto maintenanceStatus(MaintenanceStatusEnum maintenanceStatus) {
  ...
  **/
  ...
  public ValStatusV1StatusDto incidentSeverity(IncidentSeverityEnum incidentSeverity) {
  ...
  **/
  ...
  public ValStatusV1StatusDto titles(List<ValStatusV1ContentDto> titles) {
    this.titles = titles;
    return this;
  }

  public ValStatusV1StatusDto addTitlesItem(ValStatusV1ContentDto titlesItem) {
    if (this.titles == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<ValStatusV1ContentDto> getTitles() {
    return titles;
  }

  public void setTitles(List<ValStatusV1ContentDto> titles) {
    this.titles = titles;
  }


  public ValStatusV1StatusDto updates(List<ValStatusV1UpdateDto> updates) {
    this.updates = updates;
    return this;
  }

  public ValStatusV1StatusDto addUpdatesItem(ValStatusV1UpdateDto updatesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<ValStatusV1UpdateDto> getUpdates() {
    return updates;
  }

  public void setUpdates(List<ValStatusV1UpdateDto> updates) {
    this.updates = updates;
  }


  public ValStatusV1StatusDto createdAt(String createdAt) {
  ...
  **/
  ...
  public ValStatusV1StatusDto archiveAt(String archiveAt) {
  ...
  **/
  ...
  public ValStatusV1StatusDto updatedAt(String updatedAt) {
  ...
  **/
  ...
  public ValStatusV1StatusDto platforms(List<PlatformsEnum> platforms) {
    this.platforms = platforms;
    return this;
  }

  public ValStatusV1StatusDto addPlatformsItem(PlatformsEnum platformsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ValStatusV1StatusDto valStatusV1StatusDto = (ValStatusV1StatusDto) o;
    return Objects.equals(this.id, valStatusV1StatusDto.id) &&
        Objects.equals(this.maintenanceStatus, valStatusV1StatusDto.maintenanceStatus) &&
        Objects.equals(this.incidentSeverity, valStatusV1StatusDto.incidentSeverity) &&
        Objects.equals(this.titles, valStatusV1StatusDto.titles) &&
        Objects.equals(this.updates, valStatusV1StatusDto.updates) &&
        Objects.equals(this.createdAt, valStatusV1StatusDto.createdAt) &&
        Objects.equals(this.archiveAt, valStatusV1StatusDto.archiveAt) &&
        Objects.equals(this.updatedAt, valStatusV1StatusDto.updatedAt) &&
        Objects.equals(this.platforms, valStatusV1StatusDto.platforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValStatusV1StatusDto {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ValStatusV1StatusDto
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValStatusV1StatusDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValStatusV1StatusDto is not found in the empty JSON string", ValStatusV1StatusDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValStatusV1StatusDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValStatusV1StatusDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ValStatusV1StatusDto.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraytitles.size(); i++) {
        ValStatusV1ContentDto.validateJsonElement(jsonArraytitles.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayupdates.size(); i++) {
        ValStatusV1UpdateDto.validateJsonElement(jsonArrayupdates.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValStatusV1StatusDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValStatusV1StatusDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValStatusV1StatusDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValStatusV1StatusDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ValStatusV1StatusDto>() {
           @Override
           public void write(JsonWriter out, ValStatusV1StatusDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValStatusV1StatusDto read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ValStatusV1StatusDto given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValStatusV1StatusDto
  * @throws IOException if the JSON string is invalid with respect to ValStatusV1StatusDto
  */
  public static ValStatusV1StatusDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValStatusV1StatusDto.class);
  }

 /**
  * Convert an instance of ValStatusV1StatusDto to an JSON string
  *
  * @return JSON string
  */
