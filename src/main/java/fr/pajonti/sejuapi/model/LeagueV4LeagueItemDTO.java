...
public class LeagueV4LeagueItemDTO {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.freshBlood, leagueV4LeagueItemDTO.freshBlood) &&
        Objects.equals(this.wins, leagueV4LeagueItemDTO.wins) &&
        Objects.equals(this.summonerName, leagueV4LeagueItemDTO.summonerName) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to LeagueV4LeagueItemDTO
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LeagueV4LeagueItemDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeagueV4LeagueItemDTO is not found in the empty JSON string", LeagueV4LeagueItemDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LeagueV4LeagueItemDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LeagueV4LeagueItemDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeagueV4LeagueItemDTO.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeagueV4LeagueItemDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeagueV4LeagueItemDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeagueV4LeagueItemDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeagueV4LeagueItemDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<LeagueV4LeagueItemDTO>() {
           @Override
           public void write(JsonWriter out, LeagueV4LeagueItemDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LeagueV4LeagueItemDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LeagueV4LeagueItemDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeagueV4LeagueItemDTO
  * @throws IOException if the JSON string is invalid with respect to LeagueV4LeagueItemDTO
  */
  public static LeagueV4LeagueItemDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeagueV4LeagueItemDTO.class);
  }

 /**
  * Convert an instance of LeagueV4LeagueItemDTO to an JSON string
  *
  * @return JSON string
  */
