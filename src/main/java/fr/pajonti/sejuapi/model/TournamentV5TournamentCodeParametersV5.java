...
public class TournamentV5TournamentCodeParametersV5 {
  ...
  public TournamentV5TournamentCodeParametersV5() {
  }

  public TournamentV5TournamentCodeParametersV5 allowedParticipants(List<String> allowedParticipants) {
    this.allowedParticipants = allowedParticipants;
    return this;
  }

  public TournamentV5TournamentCodeParametersV5 addAllowedParticipantsItem(String allowedParticipantsItem) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeParametersV5 metadata(String metadata) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeParametersV5 teamSize(Integer teamSize) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeParametersV5 pickType(PickTypeEnum pickType) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeParametersV5 mapType(MapTypeEnum mapType) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeParametersV5 spectatorType(SpectatorTypeEnum spectatorType) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeParametersV5 enoughPlayers(Boolean enoughPlayers) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TournamentV5TournamentCodeParametersV5 tournamentV5TournamentCodeParametersV5 = (TournamentV5TournamentCodeParametersV5) o;
    return Objects.equals(this.allowedParticipants, tournamentV5TournamentCodeParametersV5.allowedParticipants) &&
        Objects.equals(this.metadata, tournamentV5TournamentCodeParametersV5.metadata) &&
        Objects.equals(this.teamSize, tournamentV5TournamentCodeParametersV5.teamSize) &&
        Objects.equals(this.pickType, tournamentV5TournamentCodeParametersV5.pickType) &&
        Objects.equals(this.mapType, tournamentV5TournamentCodeParametersV5.mapType) &&
        Objects.equals(this.spectatorType, tournamentV5TournamentCodeParametersV5.spectatorType) &&
        Objects.equals(this.enoughPlayers, tournamentV5TournamentCodeParametersV5.enoughPlayers);
  }
  ...
  public String toString() {
    ...
    sb.append("class TournamentV5TournamentCodeParametersV5 {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TournamentV5TournamentCodeParametersV5
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TournamentV5TournamentCodeParametersV5.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TournamentV5TournamentCodeParametersV5 is not found in the empty JSON string", TournamentV5TournamentCodeParametersV5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TournamentV5TournamentCodeParametersV5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TournamentV5TournamentCodeParametersV5` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TournamentV5TournamentCodeParametersV5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TournamentV5TournamentCodeParametersV5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TournamentV5TournamentCodeParametersV5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TournamentV5TournamentCodeParametersV5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TournamentV5TournamentCodeParametersV5.class));

       return (TypeAdapter<T>) new TypeAdapter<TournamentV5TournamentCodeParametersV5>() {
           @Override
           public void write(JsonWriter out, TournamentV5TournamentCodeParametersV5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TournamentV5TournamentCodeParametersV5 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TournamentV5TournamentCodeParametersV5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TournamentV5TournamentCodeParametersV5
  * @throws IOException if the JSON string is invalid with respect to TournamentV5TournamentCodeParametersV5
  */
  public static TournamentV5TournamentCodeParametersV5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TournamentV5TournamentCodeParametersV5.class);
  }

 /**
  * Convert an instance of TournamentV5TournamentCodeParametersV5 to an JSON string
  *
  * @return JSON string
  */
