...
public class SpectatorV4FeaturedGameInfo {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gameMode, spectatorV4FeaturedGameInfo.gameMode) &&
        ...
        Objects.equals(this.gameId, spectatorV4FeaturedGameInfo.gameId) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to SpectatorV4FeaturedGameInfo
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpectatorV4FeaturedGameInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpectatorV4FeaturedGameInfo is not found in the empty JSON string", SpectatorV4FeaturedGameInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpectatorV4FeaturedGameInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SpectatorV4FeaturedGameInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SpectatorV4FeaturedGameInfo.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayparticipants.size(); i++) {
        SpectatorV4Participant.validateJsonElement(jsonArrayparticipants.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpectatorV4FeaturedGameInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpectatorV4FeaturedGameInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpectatorV4FeaturedGameInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpectatorV4FeaturedGameInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SpectatorV4FeaturedGameInfo>() {
           @Override
           public void write(JsonWriter out, SpectatorV4FeaturedGameInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SpectatorV4FeaturedGameInfo read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SpectatorV4FeaturedGameInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SpectatorV4FeaturedGameInfo
  * @throws IOException if the JSON string is invalid with respect to SpectatorV4FeaturedGameInfo
  */
  public static SpectatorV4FeaturedGameInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpectatorV4FeaturedGameInfo.class);
  }

 /**
  * Convert an instance of SpectatorV4FeaturedGameInfo to an JSON string
  *
  * @return JSON string
  */
