...
public class SpectatorV4CurrentGameParticipant {
  ...
  public SpectatorV4CurrentGameParticipant() {
  }
  ...
  **/
  ...
  public SpectatorV4CurrentGameParticipant perks(SpectatorV5Perks perks) {
    this.perks = perks;
    return this;
  }
  ...
  **/
  ...
  public SpectatorV4CurrentGameParticipant puuid(String puuid) {
    this.puuid = puuid;
    return this;
  }
  ...
  **/
  ...
  public SpectatorV4CurrentGameParticipant gameCustomizationObjects(List<SpectatorV5GameCustomizationObject> gameCustomizationObjects) {
    this.gameCustomizationObjects = gameCustomizationObjects;
    return this;
  }

  public SpectatorV4CurrentGameParticipant addGameCustomizationObjectsItem(SpectatorV5GameCustomizationObject gameCustomizationObjectsItem) {
  ...
  **/
  ...
  public SpectatorV4CurrentGameParticipant riotId(String riotId) {
    this.riotId = riotId;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.championId, spectatorV4CurrentGameParticipant.championId) &&
        Objects.equals(this.perks, spectatorV4CurrentGameParticipant.perks) &&
        Objects.equals(this.profileIconId, spectatorV4CurrentGameParticipant.profileIconId) &&
        ...
        Objects.equals(this.puuid, spectatorV4CurrentGameParticipant.puuid) &&
        ...
        Objects.equals(this.riotId, spectatorV4CurrentGameParticipant.riotId);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to SpectatorV4CurrentGameParticipant
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpectatorV4CurrentGameParticipant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpectatorV4CurrentGameParticipant is not found in the empty JSON string", SpectatorV4CurrentGameParticipant.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpectatorV4CurrentGameParticipant.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SpectatorV4CurrentGameParticipant` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SpectatorV4CurrentGameParticipant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpectatorV4CurrentGameParticipant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpectatorV4CurrentGameParticipant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpectatorV4CurrentGameParticipant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpectatorV4CurrentGameParticipant.class));

       return (TypeAdapter<T>) new TypeAdapter<SpectatorV4CurrentGameParticipant>() {
           @Override
           public void write(JsonWriter out, SpectatorV4CurrentGameParticipant value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SpectatorV4CurrentGameParticipant read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SpectatorV4CurrentGameParticipant given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SpectatorV4CurrentGameParticipant
  * @throws IOException if the JSON string is invalid with respect to SpectatorV4CurrentGameParticipant
  */
  public static SpectatorV4CurrentGameParticipant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpectatorV4CurrentGameParticipant.class);
  }

 /**
  * Convert an instance of SpectatorV4CurrentGameParticipant to an JSON string
  *
  * @return JSON string
  */
