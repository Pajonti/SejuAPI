...
public class TournamentV5TournamentCodeUpdateParametersV5 {
  ...
  public TournamentV5TournamentCodeUpdateParametersV5() {
  }

  public TournamentV5TournamentCodeUpdateParametersV5 allowedParticipants(List<String> allowedParticipants) {
    this.allowedParticipants = allowedParticipants;
    return this;
  }

  public TournamentV5TournamentCodeUpdateParametersV5 addAllowedParticipantsItem(String allowedParticipantsItem) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeUpdateParametersV5 pickType(PickTypeEnum pickType) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeUpdateParametersV5 mapType(MapTypeEnum mapType) {
  ...
  **/
  ...
  public TournamentV5TournamentCodeUpdateParametersV5 spectatorType(SpectatorTypeEnum spectatorType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TournamentV5TournamentCodeUpdateParametersV5 tournamentV5TournamentCodeUpdateParametersV5 = (TournamentV5TournamentCodeUpdateParametersV5) o;
    return Objects.equals(this.allowedParticipants, tournamentV5TournamentCodeUpdateParametersV5.allowedParticipants) &&
        Objects.equals(this.pickType, tournamentV5TournamentCodeUpdateParametersV5.pickType) &&
        Objects.equals(this.mapType, tournamentV5TournamentCodeUpdateParametersV5.mapType) &&
        Objects.equals(this.spectatorType, tournamentV5TournamentCodeUpdateParametersV5.spectatorType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowedParticipants, pickType, mapType, spectatorType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TournamentV5TournamentCodeUpdateParametersV5 {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TournamentV5TournamentCodeUpdateParametersV5
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TournamentV5TournamentCodeUpdateParametersV5.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TournamentV5TournamentCodeUpdateParametersV5 is not found in the empty JSON string", TournamentV5TournamentCodeUpdateParametersV5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TournamentV5TournamentCodeUpdateParametersV5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TournamentV5TournamentCodeUpdateParametersV5` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TournamentV5TournamentCodeUpdateParametersV5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TournamentV5TournamentCodeUpdateParametersV5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TournamentV5TournamentCodeUpdateParametersV5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TournamentV5TournamentCodeUpdateParametersV5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TournamentV5TournamentCodeUpdateParametersV5.class));

       return (TypeAdapter<T>) new TypeAdapter<TournamentV5TournamentCodeUpdateParametersV5>() {
           @Override
           public void write(JsonWriter out, TournamentV5TournamentCodeUpdateParametersV5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TournamentV5TournamentCodeUpdateParametersV5 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TournamentV5TournamentCodeUpdateParametersV5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TournamentV5TournamentCodeUpdateParametersV5
  * @throws IOException if the JSON string is invalid with respect to TournamentV5TournamentCodeUpdateParametersV5
  */
  public static TournamentV5TournamentCodeUpdateParametersV5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TournamentV5TournamentCodeUpdateParametersV5.class);
  }

 /**
  * Convert an instance of TournamentV5TournamentCodeUpdateParametersV5 to an JSON string
  *
  * @return JSON string
  */
