...
<a id="valContentV1GetContent"></a>
# **valContentV1GetContent**
> ValContentV1ContentDto valContentV1GetContent(locale)
...
import fr.pajonti.sejuapi.api.ValContentV1Api;
...
public class Example {
  public static void main(String[] args) {
    ...
    ValContentV1Api apiInstance = new ValContentV1Api(defaultClient);
    String locale = "locale_example"; // String | 
    try {
      ValContentV1ContentDto result = apiInstance.valContentV1GetContent(locale);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ValContentV1Api#valContentV1GetContent");
...
[**ValContentV1ContentDto**](ValContentV1ContentDto.md)
