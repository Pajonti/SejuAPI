...
<a id="valStatusV1GetPlatformData"></a>
# **valStatusV1GetPlatformData**
> ValStatusV1PlatformDataDto valStatusV1GetPlatformData()
...
import fr.pajonti.sejuapi.api.ValStatusV1Api;
...
public class Example {
  public static void main(String[] args) {
    ...
    ValStatusV1Api apiInstance = new ValStatusV1Api(defaultClient);
    try {
      ValStatusV1PlatformDataDto result = apiInstance.valStatusV1GetPlatformData();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ValStatusV1Api#valStatusV1GetPlatformData");
...
[**ValStatusV1PlatformDataDto**](ValStatusV1PlatformDataDto.md)
